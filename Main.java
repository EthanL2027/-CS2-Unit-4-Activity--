   ...
   public static void main(String []args) throws IOException
    {
      ...
      String[] pokemonLines = new String[153];

      // Initialike a line counter
      int i = 0;
      // Loop through every line in the File using Scanner methods
      // Loop while Scanner can still find another line in the
     //  File AND our line counter is less than 10
      while ( scan.hasNext() && (i < 153) ) {
         // Read in the next line fom the File
